...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1); // достатньо тільки назви модуля, так як він встановлений чере npm?
	...
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: 'Message' }), // властивості можуть бути будь-якого типу, не лише рядок
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
	    ...
	    render: function render() {
	        // єдиний обов'язковий до визначення метод
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GreeterMessage = React.createClass({
	    ...
	    getDefaultProps: function getDefaultProps() {
	        // повернути властивості по замовчуванню
	        return {
	            name: 'Name',
	            message: 'Message'
	        };
